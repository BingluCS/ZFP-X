...
#    na = ''
filename = '../figure/rate/' +args[1]+'_de.pdf'

SZ2 = [com_s2_d[0], com_s2_d[1],com_s2_d[2],com_s2_d[3],
      com_s2_d[4],com_s2_d[5],com_s2_d[6],com_s2_d[7]]

SZ3 = [com_s3_d[0], com_s3_d[1],com_s3_d[2],com_s3_d[3],
      com_s3_d[4],com_s3_d[5],com_s3_d[6],com_s3_d[7]]

ZFP = [com_z_d[0], com_z_d[1],com_z_d[2],com_z_d[3],
      com_z_d[4],com_z_d[5],com_z_d[6],com_z_d[7]]

new_ZFP = [com_zn_d[0], com_zn_d[1],com_zn_d[2],com_zn_d[3],
      com_zn_d[4],com_zn_d[5],com_zn_d[6],com_zn_d[7]]
...
plt.ylabel("Decompression Time (S)", fontsize=22)
