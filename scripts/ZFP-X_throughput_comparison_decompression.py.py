...
SZ2=[[]]*4
SZ2[0]= [memory/com_s2_d[0], memory/com_s2_d[1],memory/com_s2_d[2],memory/com_s2_d[3]]
SZ2[1]= [memory/com_s2_d[1], memory/com_s2_d[2],memory/com_s2_d[3],memory/com_s2_d[4]]
SZ2[2]= [memory/com_s2_d[2], memory/com_s2_d[3],memory/com_s2_d[4],memory/com_s2_d[5]]
SZ2[3]= [memory/com_s2_d[3], memory/com_s2_d[4],memory/com_s2_d[5],memory/com_s2_d[6]]

SZ3=[[]]*4
SZ3[0]= [memory/com_s3_d[0], memory/com_s3_d[1],memory/com_s3_d[2],memory/com_s3_d[3]]
SZ3[1]= [memory/com_s3_d[1], memory/com_s3_d[2],memory/com_s3_d[3],memory/com_s3_d[4]]
SZ3[2]= [memory/com_s3_d[2], memory/com_s3_d[3],memory/com_s3_d[4],memory/com_s3_d[5]]
SZ3[3]= [memory/com_s3_d[3], memory/com_s3_d[4],memory/com_s3_d[5],memory/com_s3_d[6]]

ZFP=[[]]*4
ZFP[0]= [memory/com_z_d[0], memory/com_z_d[1],memory/com_z_d[2],memory/com_z_d[3]]
ZFP[1]= [memory/com_z_d[1], memory/com_z_d[2],memory/com_z_d[3],memory/com_z_d[4]]
ZFP[2]= [memory/com_z_d[2], memory/com_z_d[3],memory/com_z_d[4],memory/com_z_d[5]]
ZFP[3]= [memory/com_z_d[3], memory/com_z_d[4],memory/com_z_d[5],memory/com_z_d[6]]

new_ZFP=[[]]*4
new_ZFP[0]= [memory/com_zn_d[0], memory/com_zn_d[1],memory/com_zn_d[2],memory/com_zn_d[3]]
new_ZFP[1]= [memory/com_zn_d[1], memory/com_zn_d[2],memory/com_zn_d[3],memory/com_zn_d[4]]
new_ZFP[2]= [memory/com_zn_d[2], memory/com_zn_d[3],memory/com_zn_d[4],memory/com_zn_d[5]]
new_ZFP[3]= [memory/com_zn_d[3], memory/com_zn_d[4],memory/com_zn_d[5],memory/com_zn_d[6]]
...
# Decompression throughput on average
# zzz,r=0,0
# for i in range(4):    
    # zzz+=ZFP[2][i]
    # r+=new_ZFP[2][i]
