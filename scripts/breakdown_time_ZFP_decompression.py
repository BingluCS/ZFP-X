...
for i in range(6):
    ...
    #if(other[i]<0):
    #	other[i]=7.123+0.876*random.randint(1,15)

#print(other,'\n',trans,'\n',order,'\n',encode)
filename='/home/thinker/lb/compressor/figure/motivation/'+args[5]+'_de.pdf'
...
a=plt.legend([p1[0],p2[0]], ['other','inv_trans'],bbox_to_anchor=(0.00, 1.01), loc=3, borderaxespad=0,frameon=False,fontsize=18)

plt.legend([p4[0],p3[0]], ['decode','inv_order'],bbox_to_anchor=(1.00,1.01), loc=4, borderaxespad=0,frameon=False,fontsize=18)
plt.gca().add_artist(a)


plt.xticks(x1, x_name, fontsize=15)
plt.yticks(fontsize=18)
plt.ylabel("Decompression Time (ms)", fontsize=22)
